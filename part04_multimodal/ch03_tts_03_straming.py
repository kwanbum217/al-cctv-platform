...
def tts_streaming_save(text:str, output_dir:str="briefings_chunks", voice:str="onyx") -> List[str]:
  """
...
if __name__ == "__main__":
    ...
    files = tts_streaming_save(security_briefing, output_dir="briefings_chunks")

    print(f"[OK] 총 {len(files)}개 청크 파일 생성 완료")
